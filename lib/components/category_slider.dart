...
import 'package:passdown/models/category_model.dart';
import 'package:passdown/common_widget/circular_progress.dart';
import 'package:passdown/common_widget/grid_tiles_category.dart';
import 'package:passdown/utils/Urls.dart';
        ...
        switch (snapshot.connectionState) {
          ...
          default:
            if (snapshot.hasError)
              ...
              return null;//createListView(context, snapshot, widget.isSubList);
        }
      },
    );
  }
